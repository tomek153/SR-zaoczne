...
def relationHasProductPrice(_path, _file):
    df = ConvertToDF(_path, _file).listToDF('product_id', 'has_product_price', 'product_price')
    return df


def relationHasAge(_path, _file):
    df = ConvertToDF(_path, _file).listToDF('product_id', 'has_age', 'product_age_group')
    return df


def relationHasGender(_path, _file):
    df = ConvertToDF(_path, _file).listToDF('product_id', 'has_gender', 'product_gender')
    return df


def relationHasBrand(_path, _file):
    df = ConvertToDF(_path, _file).listToDF('product_id', 'has_brand', 'product_brand')
    return df


def relationHasCountry(_path, _file):
    df = ConvertToDF(_path, _file).listToDF('product_id', 'has_country', 'product_country')
    return df


def relationHasTitle(_path, _file):
    df = ConvertToDF(_path, _file).listToDF('product_id', 'has_title', 'product_title')
    return df
